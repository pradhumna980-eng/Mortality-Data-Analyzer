...
class ActuarialAnalyzer:
    ...
    def export_results(self, age_band, disease, outfile="mortality_results.xlsx"):
        ...
        if n > 0:
            ...
            cond_prob_file = os.path.join(static_dir, "conditional_probability.png")
            plt.savefig(cond_prob_file)
            plt.close()
        else:
            cond_prob_file = None
        ...
        if rates:
            ...
            seasonal_file = os.path.join(static_dir, "seasonal_mortality.png")
            plt.savefig(seasonal_file)
            plt.close()
        else:
            seasonal_file = None
